# sourced from: https://github.com/caiotavares/arm-hello-world/blob/master/makefile
# NOTE: using different GCC_ARMCOMPILER -> use this command instead: brew install --cask gcc-arm-embedded
